...
$(function () {
  ...
  PushMenu.prototype.init = function () {
    if (this.options.expandOnHover || $('.navigation').is(Selector.mini + Selector.layoutFixed)) {
      this.expandOnHover();
  ...
  PushMenu.prototype.open = function () {
    ...
    if (windowWidth > this.options.collapseScreenSize) {
      $('.navigation').removeClass(ClassName.collapsed).trigger($.Event(Event.expanded));
    } else {
      $('.navigation').addClass(ClassName.open).trigger($.Event(Event.expanded));
    }
  ...
  PushMenu.prototype.close = function () {
    ...
    if (windowWidth > this.options.collapseScreenSize) {
      $('.navigation').addClass(ClassName.collapsed).trigger($.Event(Event.collapsed));
    } else {
      $('.navigation').removeClass(ClassName.open + ' ' + ClassName.collapsed).trigger($.Event(Event.collapsed));
    }
  ...
  PushMenu.prototype.expandOnHover = function () {
    $(Selector.mainSidebar).on('mouseenter', function () {
      if ($('.navigation').is(Selector.mini + Selector.collapsed) && $(window).width() > this.options.collapseScreenSize) {
        this.expand();
      }
    }.bind(this), function () {
  ...
  PushMenu.prototype.expand = function () {
    setTimeout(function () {
      $('.navigation').removeClass(ClassName.collapsed).addClass(ClassName.expanded);
    }, this.options.expandTransitionDelay);
  };

  PushMenu.prototype.collapse = function () {
    setTimeout(function () {
      $('.navigation').removeClass(ClassName.expanded).addClass(ClassName.collapsed);
    }, this.options.expandTransitionDelay);
