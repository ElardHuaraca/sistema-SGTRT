    ...
    private function getCostsByProject($filters, $resources, $sows, $spla_assigned_discounts, $cost_maintenance, $date_start, $date_end)
    {
        ...
        foreach ($costs as $cost) {
            ...
            if (array_key_exists($cost['idproject'], $costs_projects)) {
                ...
                $costs_projects[$cost['idproject']]['cost_total'] += $costs_projects[$cost['idproject']]['CPU'] + $costs_projects[$cost['idproject']]['RAM'] + $costs_projects[$cost['idproject']]['DISK']
                    + $costs_projects[$cost['idproject']]['cost_splas'] + $costs_projects[$cost['idproject']]['lic_cloud'] + $costs_projects[$cost['idproject']]['backup']
                    + $costs_projects[$cost['idproject']]['mo'] + $costs_projects[$cost['idproject']]['cost_maintenance'];
            } else {
                ...
                $costs_projects[$cost['idproject']]['cost_total'] = $costs_projects[$cost['idproject']]['CPU'] + $costs_projects[$cost['idproject']]['RAM']
                    + $costs_projects[$cost['idproject']]['DISK'] + $costs_projects[$cost['idproject']]['cost_splas']
                    + $costs_projects[$cost['idproject']]['lic_cloud'] + $costs_projects[$cost['idproject']]['backup']
                    + $costs_projects[$cost['idproject']]['mo'] + $costs_projects[$cost['idproject']]['cost_maintenance'];
            }
        }
